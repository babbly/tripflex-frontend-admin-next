...
const dummyFAQs = [
  {
    ...
    answer: '<h1>테스트 텍스트</h1><p style="color: #71717A;">테스트 텍스트</p><p>테스트 텍스트</p><p>테스트 텍스트</p><p>테스트 텍스트</p><p>테스트 텍스트</p><p>테스트 텍스트</p><p>테스트 텍스트⛔ ===============================================</p><p>🎉테스트 테스트</p>',
    isActive: true
  },
];
    ...
    <div className="w-full flex flex-col gap-[24px] pb-20">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-[24px] font-[700] text-[#18181B]">FAQ 수정</h1>
        </div>
